...
var ThemeContext2 = React17.createContext(null);
if (true) {
...
var RtlContext = React20.createContext();
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React26.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React26.forwardRef(function Grid3(inProps, ref) {
    ...
    const overflow2 = React26.useContext(GridOverflowContext);
    const {
      className,
      children,
